...
public class TimedMacroScreen extends Screen {
    ...
    private static final Component TIMED_MACROS = new TranslatableComponent("mkm.text.timed_macros");
    ...
    public TimedMacroScreen() {
        ...
        buttonSwitchToNormalMacrosScreen = new VariableButton(buttonSwitchToNormalMacrosScreenX, buttonSwitchToNormalMacrosScreenY, buttonSwitchToNormalMacrosScreenWidth, buttonSwitchToNormalMacrosScreenHeight, new TranslatableComponent("mkm.text.macros").getString(), VariableButton.ButtonTexture.DEFAULT_NORMAL, mouseButton -> {
