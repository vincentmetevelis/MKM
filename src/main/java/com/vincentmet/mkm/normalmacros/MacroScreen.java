...
public class MacroScreen extends Screen {
    ...
    public MacroScreen() {
        ...
        for (Lazy<MacroKeybindWrapper> keybind : Keybinds.getAllMacros()){
            ...
            ALL_FIELDS.add(new SingleLineTextField(()->(width>>1), ()->finalY, ()->(dataContainerWidth.getAsInt()>>1), ()->20, 0xFF000000, 0xFFAAAAAA, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFEE00EE, keybind.get().getMacroGetterValue()));
            y.count();
        }
        buttonSwitchToTimedMacroScreen = new VariableButton(buttonSwitchToTimedMacroScreenX, buttonSwitchToTimedMacroScreenY, buttonSwitchToTimedMacroScreenWidth, buttonSwitchToTimedMacroScreenHeight, Component.translatable("mkm.text.timed_macros").getString(), VariableButton.ButtonTexture.DEFAULT_NORMAL, mouseButton -> {
